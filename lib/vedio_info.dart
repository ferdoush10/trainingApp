...
class _VedioInfoState extends State<VedioInfo> {
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  '60 min',
                                  style: TextStyle(fontSize: 14, color: color.AppColor.secondPageTitleColor),
                                ),
                              ],
                            ),
                          ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: TextStyle(fontSize: 12, color: color.AppColor.secondPageTitleColor),
                                ),
                              ],
                            ),
                          ),
  ...
  _onTapVideo(int index) {
    _controller = YoutubePlayerController(
      initialVideoId: YoutubePlayer.convertUrlToId(videoInfo[index]['videoUrl']) ?? '',
    ...
    return ListView.builder(
        ...
        itemBuilder: (_, int index) {
          return GestureDetector(
            onTap: () {
              _onTapVideo(index);
              debugPrint(videoInfo[index].toString());
              setState(() {
                if (_playArea == false) {
                  _playArea = true;
                } else {
